...
{
    public partial class AddedOrderHeaderAndOrderDetail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrignalTotal = table.Column<decimal>(nullable: false),
                    OrderTotal = table.Column<double>(nullable: false),
                    PickUpTime = table.Column<DateTime>(nullable: false),
                    CouponCode = table.Column<string>(nullable: true),
                    CouponCodeDiscount = table.Column<string>(nullable: true),
                    CoupnStatus = table.Column<string>(nullable: true),
